...
func buildGroupNodesList(primaryNodeName string, group *nodeGroup) ([]string, map[string]struct{}) {
...
func (p *containerlabDefinitionProcessor) processLinkForGroup(
	...
	if endpointAInGroup {
		interestingEndpoint = endpoints.endpointA
		uninterestingEndpoint = endpoints.endpointB
	} else {
		interestingEndpoint = endpoints.endpointB
		uninterestingEndpoint = endpoints.endpointA
	}
